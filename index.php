    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="http://localhost/wabc/"><i class="large material-icons">track_changes</i> <strong>target</strong></a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu waves-effect waves-dark" href="http://localhost/wabc/"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
